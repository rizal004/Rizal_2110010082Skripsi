...
<section class="content-header">     
    <h1 style="text-align:center;">Data Kritik & Saran Event</h1>     
    <ol class="breadcrumb">         
        <li>             
            <a href="index.php">                 
            ...
            <div class="table-responsive">                 
                <table id="example1" class="table table-bordered table-striped">                     
                    ...
                    <tbody>                         
                        ...
                        <tr>                             
                            <td><?= $no++; ?></td>                             
                            <td><?= htmlspecialchars($data['nama_event'] ?? 'Event Tidak Ditemukan'); ?></td>                             
                            ...
                            <td>                                 
                                <a href="?page=MyApp/edit_kritik_event&id=<?= htmlspecialchars($data['id_kritik_saran_event']); ?>"                                    
                                   class="btn btn-success btn-sm" title="Ubah">                                     
                                    <i class="glyphicon glyphicon-edit"></i>                                 
                                </a>                                 
                                <a href="?page=MyApp/del_kritik_event&id=<?= htmlspecialchars($data['id_kritik_saran_event']); ?>"                                    
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM loaded - Event Page');
    var select = document.getElementById('kategori');
    if (select) {
