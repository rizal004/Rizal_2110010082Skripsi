...
// Ambil ID Event yang akan diedit
...
if (isset($_POST['update'])) {
    ...
    // Jam operasional dengan pilihan "Sampai Selesai"
    ...
    // GAMBAR - sistem yang sama dengan edit kuliner
...
<section class="content-header">
  <h1 style="text-align:center;">Edit Event Wisata</h1>
</section>
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <select name="kategori" class="form-control" required>
            ...
            <?php foreach (["Festival","Budaya","Religi","Kuliner","Olahraga","UMKM"] as $opt): ?>
        ...
        <div class="form-group">
          ...
          <input type="text" name="provinsi" class="form-control" value="<?= htmlspecialchars($provinsi) ?>" readonly>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="no_hp" class="form-control" value="<?= htmlspecialchars($no_hp) ?>" placeholder="Contoh: 081234567890 atau +6281234567890">
        ...
        <div class="form-group">
          ...
          <div class="row">
            <?php
              // Parsing jam operasional existing
              $jamBuka = '';
              $jamTutup = '';
              $sampaiSelesai = false;
              
              if (!empty($jam_operasional)) {
                  if (strpos($jam_operasional, 'Sampai Selesai') !== false) {
                      $sampaiSelesai = true;
                      $jamBuka = trim(str_replace('- Sampai Selesai', '', $jam_operasional));
                  } else {
                      list($jamBuka, $jamTutup) = array_pad(explode(' - ', $jam_operasional), 2, '');
                  }
              }
            ?>
            <div class="col-md-6">
              <label>Jam Buka</label>
              <input type="time" name="jam_buka" id="jam_buka" class="form-control" value="<?= $jamBuka ?>" required>
            </div>
            <div class="col-md-6">
              <label>Jam Tutup</label>
              <input type="time" name="jam_tutup" id="jam_tutup" class="form-control" value="<?= $jamTutup ?>" <?= $sampaiSelesai ? 'disabled' : '' ?> <?= $sampaiSelesai ? '' : 'required' ?>>
            </div>
          </div>
          <div class="checkbox-custom">
            <input type="checkbox" name="sampai_selesai" id="sampai_selesai" value="1" <?= $sampaiSelesai ? 'checked' : '' ?>>
        ...
        <div class="form-group">
          ...
          <input type="text" name="harga_tiket" class="form-control" value="<?= htmlspecialchars($harga_tiket) ?>" placeholder="Contoh: Gratis atau Rp. 50.000" required>
        </div>
