...
if (isset($_POST['save'])) {
    ...
    // Insert ke database
    $sql = $koneksi->query("
        INSERT INTO tb_oleh2 (
            id_oleh2, nama_toko, provinsi, kabupaten, kecamatan,
            alamat, harga_range, jam_operasional, barang_dijual,
            gambar, deskripsi, tanggal_upload, latitude, longitude
        ) VALUES (
            '$id_oleh2', '$nama_toko', '$provinsi', '$kabupaten', '$kecamatan',
            '$alamat', '$harga_range', '$jam_operasional', '$barang_dijual',
...
<section class="content-header">
    <h1 style="text-align:center;">Tambah Oleh‐oleh Khas</h1>
</section>
<section class="content">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Form Tambah Oleh‐oleh</h3>
        </div>
        <form method="POST" enctype="multipart/form-data">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" step="any" name="latitude" class="form-control" placeholder="-1.6..." required>
                </div>
                <div class="form-group">
                    <label>Longitude</label>
                    <input type="text" step="any" name="longitude" class="form-control" placeholder="113.6..." required>
                </div>
                <!-- Rentang Harga -->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="barang_dijual" class="form-control" rows="2" placeholder="Contoh: Kain Tenun, Souvenir Kayu, Sirup Aren" required></textarea>
                </div>
                <!-- Gambar -->
                <div class="form-group">
