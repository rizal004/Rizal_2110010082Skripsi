...
<style>
body {
    background: linear-gradient(120deg, #8e44ad 0%, #9b59b6 100%) !important;
...
.content-header h1 { color: #fff !important; text-shadow:1px 2px 8px rgba(142,68,173,0.3); }
.breadcrumb {
...
.box.box-primary, .box.box-info {
    ...
    border-radius: 12px;
    box-shadow: 0 4px 20px 0 rgba(142,68,173,0.06);
...
.btn-info { background: linear-gradient(90deg, #bb8fce 0%, #a569bd 100%); border: none; color: #fff;}
.btn-primary { background: linear-gradient(90deg, #8e44ad 0%, #6c3483 100%); border: none; color: #fff;}
.btn-success { background: linear-gradient(90deg, #27ae60 0%, #229954 100%); border: none; color: #fff;}
.btn-info:hover, .btn-primary:hover, .btn-success:hover { filter: brightness(1.12); }
.table-responsive { border-radius: 16px; box-shadow: 0 4px 18px rgba(142,68,173,0.09); background: #fff;}
.table-bordered>thead>tr { background: linear-gradient(90deg, #8e44ad 10%, #6c3483 100%); color: #fff; font-size: 15px;}
.table-bordered>tbody>tr:nth-child(even) { background: #faf5ff;}
...
.chart-container {
    ...
    background: #fff;
    border-radius: 12px;
    box-shadow: 0 4px 18px rgba(142,68,173,0.09);
}
...
<section class="content-header">
    <h1 style="text-align:center; color:#fff !important;">Cetak Data Kritik Oleh-oleh</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li>
            <a href="?page=MyApp/cetak_kritik_oleh2" style="color:black;">Kritik Oleh-oleh</a>
        </li>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-control" onchange="redirectToCategory(this.value)">
                        ...
                        <option value="oleh2" selected>Kritik dan Saran Oleh-oleh</option>
...
<section class="content">
    <div class="box box-primary">
        ...
        <form method="GET" action="">
            <input type="hidden" name="page" value="MyApp/cetak_kritik_oleh2">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="tahun" class="form-control">
                                ...
                                <?php
                                $tahun_query = $koneksi->query("SELECT DISTINCT YEAR(tanggal) as tahun FROM tb_kritik_saran_oleh2 ORDER BY tahun DESC");
    ...
    <div class="box box-info">
        <div class="box-header with-border" style="background:linear-gradient(90deg, #8e44ad 0%, #6c3483 100%);color:#fff;">
        ...
        <div class="box-body">
            <div id="printArea">
                <div class="text-center" style="margin-bottom: 20px;">
                    <h2 style="color:#222;"><b>LAPORAN DATA KRITIK OLEH-OLEH</b></h2>
                    <h4 style="color:#8e44ad;">Si Wisata</h4>
                    <?php
                    $bulan_array = [
                        1 => 'Januari', 2 => 'Februari', 3 => 'Maret', 4 => 'April',
                        5 => 'Mei', 6 => 'Juni', 7 => 'Juli', 8 => 'Agustus',
                    ...
                    if(isset($_GET['cetak_semua'])) {
                        echo "<p><b>Semua Data Kritik Oleh-oleh</b></p>";
                    } else {
                        $filter_text = [];
                ...
                <div class="row chart-section" style="margin-bottom: 30px;">
                    <div class="col-md-6">
                        <div class="chart-container">
                            <h4 style="text-align: center; color: #8e44ad; margin-bottom: 20px;">Distribusi Rating</h4>
                            <canvas id="ratingChart"></canvas>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="chart-container">
                            <h4 style="text-align: center; color: #8e44ad; margin-bottom: 20px;">Tren Kritik per Bulan</h4>
                    ...
                    <table class="table table-bordered" style="font-size: 12px;">
                        ...
                        <tbody>
                            ...
                            $sql = $koneksi->query("SELECT ks.*, 
                                                   ...
                                                   LEFT JOIN tb_oleh2 o ON ks.id_oleh2 = o.id_oleh2 
                ...
                <div style="margin-top: 20px;">
                    <h4 style="color:#8e44ad;"><b>Ringkasan Statistik</b></h4>
                    <div class="row">
                        <?php
                        // Get statistics
