...
<section class="content-header">     
    <h1 style="text-align:center;">Data Kritik & Saran Oleh-oleh</h1>     
    <ol class="breadcrumb">         
        <li>             
            <a href="index.php">                 
            ...
            <div class="table-responsive">                 
                <table id="example1" class="table table-bordered table-striped">                     
                    ...
                    <tbody>                         
                        ...
                        <tr>                             
                            <td><?= $no++; ?></td>                             
                            <td><?= htmlspecialchars($data['nama_toko'] ?? 'Oleh-oleh Tidak Ditemukan'); ?></td>                             
                            ...
                            <td>                                 
                                <a href="?page=MyApp/edit_kritik_oleh2&id=<?= htmlspecialchars($data['id']); ?>"                                    
                                   class="btn btn-success btn-sm" title="Ubah">                                     
                                    <i class="glyphicon glyphicon-edit"></i>                                 
                                </a>                                 
                                <a href="?page=MyApp/del_kritik_oleh2&id=<?= htmlspecialchars($data['id']); ?>"                                    
...
$(document).ready(function() {
    $('#example1').DataTable({
        ...
        "columnDefs": [
            ...
            { "width": "20%", "targets": [1] }, // Nama Oleh-oleh
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM loaded - Oleh-oleh Page');
    var select = document.getElementById('kategori');
    if (select) {
...
/* Highlight untuk halaman oleh-oleh */
.content-header h1 {
    color: #9b59b6;
}
