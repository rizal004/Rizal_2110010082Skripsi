...
.content-header h1 { color: #fff !important; text-shadow:1px 2px 8px rgba(192,57,43,0.3); }
.breadcrumb {
...
.box.box-primary, .box.box-info {
    ...
    border-radius: 12px;
    box-shadow: 0 4px 20px 0 rgba(192,57,43,0.06);
...
.btn-info { background: linear-gradient(90deg, #ec7063 0%, #e74c3c 100%); border: none; color: #fff;}
.btn-primary { background: linear-gradient(90deg, #c0392b 0%, #e74c3c 100%); border: none; color: #fff;}
...
.table-responsive { border-radius: 16px; box-shadow: 0 4px 18px rgba(192,57,43,0.09); background: #fff;}
.table-bordered>thead>tr { background: linear-gradient(90deg, #c0392b 10%, #e74c3c 100%); color: #fff; font-size: 15px;}
.table-bordered>tbody>tr:nth-child(even) { background: #fdf2f2;}
...
.chart-container {
    ...
    background: #fff;
    border-radius: 12px;
    box-shadow: 0 4px 18px rgba(192,57,43,0.09);
}
...
<section class="content-header">
    <h1 style="text-align:center; color:#fff !important;">Cetak Data Kritik Hotel</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li>
            <a href="?page=MyApp/cetak_kritik_hotel" style="color:black;">Kritik Hotel</a>
        </li>
...
<section class="content">
    <div class="box box-primary">
        ...
        <form method="GET" action="">
            <input type="hidden" name="page" value="MyApp/cetak_kritik_hotel">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="tahun" class="form-control">
                                ...
                                <?php
                                $tahun_query = $koneksi->query("SELECT DISTINCT YEAR(tanggal) as tahun FROM tb_kritik_saran_hotel ORDER BY tahun DESC");
    ...
    <div class="box box-info">
        <div class="box-header with-border" style="background:linear-gradient(90deg, #c0392b 0%, #e74c3c 100%);color:#fff;">
        ...
        <div class="box-body">
            <div id="printArea">
                <div class="text-center" style="margin-bottom: 20px;">
                    <h2 style="color:#222;"><b>LAPORAN DATA KRITIK HOTEL</b></h2>
                    <h4 style="color:#c0392b;">Si Kuliner</h4>
                    <?php
                    $bulan_array = [
                        1 => 'Januari', 2 => 'Februari', 3 => 'Maret', 4 => 'April',
                        5 => 'Mei', 6 => 'Juni', 7 => 'Juli', 8 => 'Agustus',
                    ...
                    if(isset($_GET['cetak_semua'])) {
                        echo "<p><b>Semua Data Kritik Hotel</b></p>";
                    } else {
                        $filter_text = [];
                ...
                <div class="row chart-section" style="margin-bottom: 30px;">
                    <div class="col-md-6">
                        <div class="chart-container">
                            <h4 style="text-align: center; color: #c0392b; margin-bottom: 20px;">Distribusi Rating</h4>
                            <canvas id="ratingChart"></canvas>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="chart-container">
                            <h4 style="text-align: center; color: #c0392b; margin-bottom: 20px;">Tren Kritik per Bulan</h4>
                ...
                <div style="margin-top: 20px;">
                    <h4 style="color:#c0392b;"><b>Ringkasan Statistik</b></h4>
                    <div class="row">
                        <?php
                        // Get statistics
