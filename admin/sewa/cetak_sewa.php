...
.content-header h1 { color: #fff !important; text-shadow:1px 2px 8px rgba(52,152,219,0.3); }
.breadcrumb {
...
.box.box-primary, .box.box-info {
    ...
    border-radius: 12px;
    box-shadow: 0 4px 20px 0 rgba(52,152,219,0.06);
...
.btn-info { background: linear-gradient(90deg, #8b5cf6 0%, #7c3aed 100%); border: none; color: #fff;}
.btn-primary { background: linear-gradient(90deg, #3498db 0%, #2980b9 100%); border: none; color: #fff;}
.btn-success { background: linear-gradient(90deg, #10b981 0%, #059669 100%); border: none; color: #fff;}
.btn-info:hover, .btn-primary:hover, .btn-success:hover { filter: brightness(1.12); }
.table-responsive { border-radius: 16px; box-shadow: 0 4px 18px rgba(52,152,219,0.09); background: #fff;}
.table-bordered>thead>tr { background: linear-gradient(90deg, #3498db 10%, #2980b9 100%); color: #fff; font-size: 15px;}
...
<section class="content-header">
    <h1 style="text-align:center; color:black !important;">Laporan Data Sewa Kendaraan</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li>
            <a href="?page=MyApp/tabel_sewa" style="color:black;">Data Sewa Kendaraan</a>
        </li>
...
<section class="content">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="tahun" class="form-control">
                                ...
                                <?php
                                $tahun_query = $koneksi->query("SELECT DISTINCT YEAR(tanggal_upload) as tahun FROM tb_motor ORDER BY tahun DESC");
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="kabupaten" class="form-control">
                                ...
                                <?php
                                $kabupaten_query = $koneksi->query("SELECT DISTINCT kabupaten FROM tb_motor ORDER BY kabupaten ASC");
    ...
    <div class="box box-info">
        <div class="box-header with-border" style="background:linear-gradient(90deg, #3498db 0%, #2980b9 100%);color:#fff;">
        ...
        <div class="box-body">
            <div id="printArea">
                <div class="text-center" style="margin-bottom: 20px;">
                    <h2 style="color:#222;"><b>LAPORAN DATA SEWA KENDARAAN</b></h2>
                    <h4 style="color:#3498db;">Si Wisata</h4>
                    <?php
                    $bulan_array = [
                        1 => 'Januari', 2 => 'Februari', 3 => 'Maret', 4 => 'April',
                        5 => 'Mei', 6 => 'Juni', 7 => 'Juli', 8 => 'Agustus',
                        ...
                        <tbody>
                            ...
                            if(isset($_GET['filter'])) {
                                ...
                                if(!empty($_GET['jenis_kendaraan'])) {
                                    $where_conditions[] = "jenis_kendaraan = '".$koneksi->real_escape_string($_GET['jenis_kendaraan'])."'";
                                }
                            ...
                            $sql = $koneksi->query("SELECT * FROM tb_motor $where_clause ORDER BY tanggal_upload DESC");
                            if($sql->num_rows > 0) {
                                while ($data = $sql->fetch_assoc()) {
                                    ...
                                    $kontakInfo = $namaKontak . ($noTelepon !== '-' ? ' - ' . $noTelepon : '');
                            ?>
                            <tr>
