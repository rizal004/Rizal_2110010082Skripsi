...
.btn-info { background: linear-gradient(90deg, #ff6b6b 0%, #ee5a52 100%); border: none; color: #fff;}
.btn-primary { background: linear-gradient(90deg, #e74c3c 0%, #c0392b 100%); border: none; color: #fff;}
.btn-success { background: linear-gradient(90deg, #e67e22 0%, #d35400 100%); border: none; color: #fff;}
...
.table-bordered>thead>tr { background: linear-gradient(90deg, #e74c3c 10%, #c0392b 100%); color: #fff; font-size: 15px;}
...
<section class="content-header">
    <h1 style="text-align:center; color:#fff !important;">Cetak Data Kritik Kuliner</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li>
            <a href="?page=MyApp/cetak_kritik_kuliner" style="color:black;">Kritik Kuliner</a>
        </li>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-control" onchange="redirectToCategory(this.value)">
                        ...
                        <option value="kuliner" selected>Kritik dan Saran Kuliner</option>
...
<section class="content">
    <div class="box box-primary">
        ...
        <form method="GET" action="">
            <input type="hidden" name="page" value="MyApp/cetak_kritik_kuliner">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="tahun" class="form-control">
                                ...
                                <?php
                                $tahun_query = $koneksi->query("SELECT DISTINCT YEAR(tanggal) as tahun FROM tb_kritik_saran_kuliner ORDER BY tahun DESC");
    ...
    <div class="box box-info">
        <div class="box-header with-border" style="background:linear-gradient(90deg, #e74c3c 0%, #c0392b 100%);color:#fff;">
        ...
        <div class="box-body">
            <div id="printArea">
                <div class="text-center" style="margin-bottom: 20px;">
                    <h2 style="color:#222;"><b>LAPORAN DATA KRITIK KULINER</b></h2>
                    ...
                    if(isset($_GET['cetak_semua'])) {
                        echo "<p><b>Semua Data Kritik Kuliner</b></p>";
                    } else {
                        $filter_text = [];
                ...
                <div class="row chart-section" style="margin-bottom: 30px;">
                    <div class="col-md-6">
                        <div class="chart-container">
                            <h4 style="text-align: center; color: #e74c3c; margin-bottom: 20px;">Distribusi Rating</h4>
                            <canvas id="ratingChart"></canvas>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="chart-container">
                            <h4 style="text-align: center; color: #e74c3c; margin-bottom: 20px;">Tren Kritik per Bulan</h4>
                    ...
                    <table class="table table-bordered" style="font-size: 12px;">
                        ...
                        <tbody>
                            ...
                            $sql = $koneksi->query("SELECT ks.*, 
                                                   ...
                                                   LEFT JOIN tb_kuliner k ON ks.id_kuliner = k.id_kuliner 
                ...
                <div style="margin-top: 20px;">
                    <h4 style="color:#e74c3c;"><b>Ringkasan Statistik</b></h4>
                    <div class="row">
                        <?php
                        // Get statistics
