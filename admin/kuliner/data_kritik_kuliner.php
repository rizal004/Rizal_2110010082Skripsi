...
<section class="content-header">     
    <h1 style="text-align:center;">Data Kritik & Saran Kuliner</h1>     
    <ol class="breadcrumb">         
        <li>             
            <a href="index.php">                 
                ...
                <table id="example1" class="table table-bordered table-striped">                     
                    ...
                    <tbody>                         
                        ...
                        $sql = $koneksi->query("SELECT 
                            ...
                            WHERE ks.id_kuliner IS NOT NULL
                        ...
                        <tr>                             
                            <td><?= $no++; ?></td>                             
                            <td><?= htmlspecialchars($data['nama_kuliner'] ?? 'Kuliner Tidak Ditemukan'); ?></td>                             
                            ...
                            <td>                                 
                                <a href="?page=MyApp/edit_kritik_kuliner&id=<?= htmlspecialchars($data['id_kritik_saran']); ?>"                                    
                                   class="btn btn-success btn-sm" title="Ubah">                                     
                                    <i class="glyphicon glyphicon-edit"></i>                                 
                                </a>                                 
                                <a href="?page=MyApp/del_kritik_kuliner&id=<?= htmlspecialchars($data['id_kritik_saran']); ?>"                                    
...
$(document).ready(function() {
    $('#example1').DataTable({
        ...
        "columnDefs": [
            ...
            { "width": "20%", "targets": [1] }, // Nama Kuliner
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM loaded - Kuliner Page');
    var select = document.getElementById('kategori');
    if (select) {
...
/* Highlight untuk halaman kuliner */
.content-header h1 {
    color: #e67e22;
}
