...
<section class="content-header">
    <h1 style="text-align:center; color:#222 !important;">Laporan Data Kuliner</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li>
            <a href="?page=MyApp/tabel_kuliner" style="color:black;">Data Kuliner</a>
        </li>
...
<section class="content">
    <div class="box box-primary">
        ...
        <form method="GET" action="">
            <input type="hidden" name="page" value="MyApp/cetak_kuliner">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="tahun" class="form-control">
                                ...
                                <?php
                                $tahun_query = $koneksi->query("SELECT DISTINCT YEAR(tanggal_upload) as tahun FROM tb_kuliner ORDER BY tahun DESC");
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="kabupaten" class="form-control">
                                ...
                                <?php
                                $kabupaten_query = $koneksi->query("SELECT DISTINCT kabupaten FROM tb_kuliner ORDER BY kabupaten ASC");
        ...
        <div class="box-body">
            <div id="printArea">
                <div class="text-center" style="margin-bottom: 20px;">
                    <h2 style="color:#222;"><b>LAPORAN DATA KULINER</b></h2>
                    <h4 style="color:#1e90ff;">Si Kuliner</h4>
                    <?php
                    $bulan_array = [
                        1 => 'Januari', 2 => 'Februari', 3 => 'Maret', 4 => 'April',
                        5 => 'Mei', 6 => 'Juni', 7 => 'Juli', 8 => 'Agustus',
                    ...
                    if(isset($_GET['cetak_semua'])) {
                        echo "<p><b>Semua Data Kuliner</b></p>";
                    } else {
                        $filter_text = [];
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" style="font-size: 12px;">
                        ...
                        <tbody>
                            ...
                            $sql = $koneksi->query("SELECT * FROM tb_kuliner $where_clause ORDER BY tanggal_upload DESC");
                            if($sql->num_rows > 0) {
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($data['menu']); ?></td>
                                <td><?= htmlspecialchars($data['special_menu']); ?></td>
                                <td>
                                    <?php 
